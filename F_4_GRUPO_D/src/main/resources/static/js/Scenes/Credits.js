...
export default class Credits extends Phaser.Scene{
    ...
    create(){
        this.style = { font: "15px OCR A EXTENDED", fill: "#FFFFFF" };
        this.add.text(10, 10, 'Para salir pulsa la barra espaciadora', this.style);
        this.style1 = { font: "30px OCR A EXTENDED", fill: "#FFFFFF" };
        this.add.text(250, 100, 'Creadores, game designers y programadores: ', this.style1);
        this.add.text(300, 150, '-> Jesús Culebras González \n-> Aitor Lebrero Barroso \n-> Marcos Toledo Sánchez ', this.style1);
